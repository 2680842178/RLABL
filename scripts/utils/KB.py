...
def Mutiagent_collect_experiences(env, acmodels, stateNN, device, num_frames_per_proc, discount, gae_lambda,
                                  preprocess_obss, epsilon):
...
def Mutiagent_collect_experiences_q(env, acmodels, stateNN, device, num_frames_per_proc, discount, gae_lambda,
                                    preprocess_obss, epsilon):
    agent_num = len(acmodels)
    obs = env.gen_obs()
